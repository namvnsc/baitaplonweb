        ...
        <div id="all1" style="height: 1000px;">
            <div id="headerone">
                ...
                <div id="headerone2">
                    ...
                    <a href="" class="button-back-next1" style="padding: 10px 10px 10px;">Đăng Nhập</a>
                    <a href="Views/signUp.jsp" class="button-back-next1" style="padding: 10px;">Đăng Ký</a>
            ...
            <div id="header1" style="height: 800px">
                <div id="h11" >
                    ...
                    <img class="contactIcon1" src="Views/resources/muitenn.png" style="background-image: none; padding-left: 300px "alt=ttps://www.flaticon.com/premium-icon/icons/svg/510/510808.svg" st""/>
                ...
                <div id="h12" >
                    ...
                    <br><br>
                        ...
                        <form action="Views/login" method="POST" style="margin-left:0%; margin-top: 5px;">
                        ...
                        <span style="font-size: 25px;">
                            ...
                            <% } %>Chưa có tài khoản?<a href="Views/signUp.jsp" style="padding: 10px; color: #CAFF70">Đăng ký ngay</a></span>
