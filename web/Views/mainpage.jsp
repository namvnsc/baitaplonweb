    ...
    <body>
        <div id="all">
            ...
            <div id="profile">
                ...
                <br>
                <br>
                <div class="text"><h3>Thông tin học viên</h3></div>
                <div class="box">
                    <div>
                        <img class="img-container1" id="avt" src="<%= avt%>" style="width: 200px; height: 200px;">
                    </div>
                    <div>
                        <p class="text-justify">
                            <br><span class="title">Tài khoản:</span>
                            <%= a.getUsername()%>
            ...
            <div id="profile-content">
                <div id="detail">
                    <ul><li><h3>Ngôn ngữ yêu thích</h3></li></ul>
                            <%= session.getAttribute("username")%>
                    <br>
                    <ul><li><h3>Framework yêu thích</h3></li></ul>

                </div>
                <hr>
                <div id="khoahoc">
                    <ul><li><h3>Các khóa học đang theo</h3></li></ul>
                            <% for (KhoaHoc kh : list) {%>
                    <div id="khoa">
