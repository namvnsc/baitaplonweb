            ...
            <div id="headerone">
                ...
                <div id="headerLH" style="margin: 0px">
                    <div class="DivMenu">
                        ...
                        <a href="list_contest.jsp" class="button-back-next1"><b>Luyên tập</b></a>
                            ...
                            function (response) {
                                ...
                                response.json().then(function (data) {
                                    ...
                                    var txt = "<thead><tr>" +
                                            ...
                                            "<th class='_w30'>Bài tập</th>" +
                                            "<th class='_w20'>Điểm số</th>" +
                                            "<th class='_w20'>Trạng thái</th>" +
                                            "<th class='_w20'>Làm bài</th>" +
                                            "</tr></thead>";
                                    tmp = data.listRs
                                    for (x in tmp) {
                                        txt += "<tr>" +
                                        ...
                                        txt += "<td><a href=\"problem.jsp?maBaiTap=" + tmp[x].problem.baiTap.ma + "&maContest=" + '<%=request.getParameter("maContest")%>' + "\"> Bắt đầu </a></td>" +
                                                "</tr>";
                                    }
