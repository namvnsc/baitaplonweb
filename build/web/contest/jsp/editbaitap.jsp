...
<!--                <h1 style="padding: 100px 0px 0px 450px;  margin: 0; font-size: 200px; font-family: inherit;"></h1>
            ...
            <div id="body" style="height: 800px; background-color: whitesmoke;">
                ...
                <div style="height: 100%; width: 50%; float:left">
                    ...
                    Mã<br>
                    <input type="text" id='txtma' size="77" required><br>
                    Tên<br>
                    <input type="text" id='txtten' size="77" required><br>
                    Đề bài(format yyyy-MM-dd hh:mm:ss) <br>
                    <textarea type="text" id='txtde' cols="70" rows="5"  required> </textarea><br>
                    Giới hạn thời gian<br>
                    <input type="text" id='txtthoigian' size="77" required><br>
                    Input<br>
                    <textarea type="text" id='txtin' cols="70" rows="5" required> </textarea><br>
                    Output<br>
                    <textarea type="text" id='txtout' cols="70" rows="5" required> </textarea><br><br>
